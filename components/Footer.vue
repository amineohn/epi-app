<template>
  <footer class="footer">
    <div class="content has-text-centered">
      <p style="display: inline-flex; text-align: center; width: 30%">
        <a href="mailto:epihelpcie@gmail.com">
          <svg
          ...
          <pcode>epihelpcie@gmail.com</pcode> </a
        >&nbsp;
        <a href="https://instagram.com/epihelpcie" target="_blank">
          <svg
            style="margin-bottom: -6%"
            width="28"
            height="28"
          ...
          ><pcode style="margin-left: 2px">@epihelpcie</pcode>
        </a>
      </p>
    </div>
  </footer>
